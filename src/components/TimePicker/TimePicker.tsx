...
export const TimePicker:React.FC<TimePickerProps> = ({setReservation,reservation}) => {
    ...
    console.log(reservation.hours == reservationHour.getHours() && reservation.minutes == reservationHour.getMinutes())
console.log(`Hora: ${reservation.hours}`)
console.log(`minuto: ${reservation.minutes}`)
